...
%% \input{Elle-inc}
\input{LAM-inc}
\renewcommand{\LAMdrule}[4][]{{\displaystyle\frac{\begin{array}{l}#2\end{array}}{#3}\,#4}}
%% OTT Renaming
\renewcommand{\LAMdruleNAXXidName}{\text{id}}
\renewcommand{\LAMdruleNAXXunitIName}{\mathsf{Unit}_i}
\renewcommand{\LAMdruleNAXXunitEName}{\mathsf{Unit}_e}
\renewcommand{\LAMdruleNAXXtenIName}{\rhd_i}
\renewcommand{\LAMdruleNAXXtenETwoName}{\rhd_e}
\renewcommand{\LAMdruleNAXXimprIName}{\rightharpoonup_i}
\renewcommand{\LAMdruleNAXXimprEName}{\rightharpoonup_e}
\renewcommand{\LAMdruleNAXXimplIName}{\leftharpoonup_i}
\renewcommand{\LAMdruleNAXXimplEName}{\leftharpoonup_e}
%% End Ott Renaming
...
\title{Adjoint Models for the Lambek Calculus}
...
\def\authorrunning{J. Jiang \& H. Eades III}
...
\section{Adjoint Models for the (non-associative) Lambek Calculus}
\label{sec:adjoint-models}

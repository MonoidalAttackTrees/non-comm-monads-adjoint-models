...
\begin{proof}
  ...
  \item Both proofs end in logical rules which introduce the cut formula, i.e. $\Pi_1$ ends
    ...
    \item $<<UnitT>>$:
      ...
      in $\Pi_2$ for sequent $<<I |-c X>>$. So $\Pi=\Pi_2\leq |<<UnitT>>|$.
    ...
    \item $\otimes$:
      ...
      $c(\Pi)\leq max\{\pi_1,\pi_2,\pi_3,|X|+1,|Y|+1\}\leq |X|+|Y|+1 = |<<X (x) Y>>|$.
      \begin{center}
        \scriptsize
        \begin{math}
          $$\mprset{flushleft}
    ...
    \item $<<UnitS>>$:
      ...
      in $\Pi_2$ for sequent $<<D |-l A>>$. So $\Pi=\Pi_2\leq |<<UnitS>>|$.
    ...
    \item $\tri$:
      ...
      constructed as follows, and
      $c(\Pi)\leq max\{\pi_1,\pi_2,\pi_3,|A|+1,|B|+1\}\leq |A|+|B|+1 = |<<A (>) B>>|$.
      \begin{center}
        \scriptsize
        \begin{math}
          $$\mprset{flushleft}
    ...
    \item $\rto$:
      ...
      constructed as follows, and
      $c(\Pi)\leq max\{\pi_1,\pi_2,\pi_3,|A|+1,|B|+1\}\leq |A|+|B|+1 = |<<B <- A>>|$.
      \begin{center}
        \scriptsize
        \begin{math}
          $$\mprset{flushleft}
    ...
    \item $F$:
      ...
      constructed as follows, and $c(\Pi)\leq max\{\pi_1,\pi_2,|X|+1\}\leq |<<F X>>|$.
      \begin{center}
        \scriptsize
        \begin{math}
          $$\mprset{flushleft}
    ...
    \item $G$:
      ...
      constructed as follows, and $c(\Pi)\leq max\{\pi_1,\pi_2,|A|+1\}\leq |<<Gf A>>|$.
      \begin{center}
        \scriptsize
        \begin{math}
          $$\mprset{flushleft}
